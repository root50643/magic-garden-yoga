...
| 了解主 VRM 與小攝影機版面 | [DEVELOPMENT.md：畫面配置](DEVELOPMENT.md#畫面配置) |
| 了解手指／表情為何不影響分數 | [DEVELOPMENT.md：顯示專用手部與臉部追蹤](DEVELOPMENT.md#顯示專用手部與臉部追蹤) |
| 修改程式並執行測試 | [DEVELOPMENT.md：開發工作流程](DEVELOPMENT.md#開發工作流程) |
| 調整某一關的通過分數 | [CONFIGURATION.md：每關設定](CONFIGURATION.md#每關姿勢欄位) |
| 調整或關閉手指／表情同步 | [CONFIGURATION.md：avatarTracking](CONFIGURATION.md#avatartracking) |
| 檢查手腕翻掌、四指張合或拇指骨鏈 | [CONFIGURATION.md：手腕與手指微調順序](CONFIGURATION.md#手腕與手指微調順序) |
...
| 不用真人追蹤資料驗收 VRM 手指／表情 | [DEVELOPMENT.md：avatarDebug](DEVELOPMENT.md#avatardebug-顯示驗收模式) |
| 更新 MediaPipe、Three.js 或 VRM 套件 | [MAINTENANCE.md：更新依賴](MAINTENANCE.md#依賴與模型更新) |
| 排除手腕翻轉、手指／表情不同步 | [MAINTENANCE.md：手腕、手指或表情不同步](MAINTENANCE.md#手腕手指或表情不同步) |
